...
btncarLoan.onclick = function() {
  ...
  lblmessage.value = `A car loan for $${carLoanPrinciple} over ${carLoanMonths} months at ${carLoanInterest} percent interest would have a monthly payment of $${carTotal}`
}
...
btnHomeLoan.onclick = function() {
  ...
  homeLoanInterest = Number(inptMonthlyInterest.value)
